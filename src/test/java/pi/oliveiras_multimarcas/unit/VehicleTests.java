...
public class VehicleTests {
    ...
    @ParameterizedTest
    @CsvSource({
            "'Civic EXL', 2026, '0', '{https://example.com/images/civic_exl_front.jpg, https://example.com/images/civic_exl_interior.jpg, https://example.com/images/civic_exl_rear.jpg}', 'Sedan médio com ótimo desempenho, conforto e baixo consumo de combustível.', 32000, 'Honda'",
            ...
            "'Onix LTZ', 2023, '-10', '{https://example.com/images/onix_ltz_front.jpg, https://example.com/images/onix_ltz_side.jpg, https://example.com/images/onix_ltz_interior.jpg}', 'Hatch compacto moderno, com excelente consumo e conectividade.', 12000, 'Chevrolet'",
            "'Polo Comfortline', 2010, '129000.00', '{https://example.com/images/polo_front.jpg, https://example.com/images/polo_side.jpg, https://example.com/images/polo_interior.jpg}', 'Hatch médio, confortável e seguro, ideal para uso urbano.', 25000, 'Volkswagen'"
    })
